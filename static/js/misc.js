        ...
        (this.options = A || {}),
            ...
            (this.add = function (A) {
                ...
                for (
                    null === document.head.querySelector('style.anchorjs') &&
                        ...
                        u.sheet.insertRule(':hover>.anchorjs-link,.anchorjs-link:focus{opacity:1}', u.sheet.cssRules.length),
                        u.sheet.insertRule('[data-anchorjs-icon]::after{content:attr(data-anchorjs-icon)}', u.sheet.cssRules.length),
                        u.sheet.insertRule(
                    ...
                    if (this.hasAnchorJSLink(e[i])) p.push(i);
                        ...
                        ((r = document.createElement('a')).className = 'anchorjs-link ' + this.options.class),
                            ...
                            (h = document.querySelector('base') ? window.location.pathname + window.location.search : ''),
                            (h = this.options.base || h),
                            (r.href = h + '#' + o),
                            'always' === l && (r.style.opacity = '1'),
                            '' === this.options.icon &&
                                ((r.style.font = '1em/1 anchorjs-icons'), 'left' === this.options.placement && (r.style.lineHeight = 'inherit')),
            ...
            (this.remove = function (A) {
                for (var e, t, o = w(A), i = 0; i < o.length; i++)
                    (t = o[i].querySelector('.anchorjs-link')) && (-1 !== (e = this.elements.indexOf(o[i])) && this.elements.splice(e, 1), o[i].removeChild(t));
                return this;
            }),
