...
*/
    ...
    Fj.prototype.l = function (a, b, c) {
        'function' === typeof c && 'getUSPData' === a && c({ version: 1, uspString: this.j }, !0);
    };
    function Ij(a) {
        var b = /[a-zA-Z0-9._~-]/,
            c = /%[89a-zA-Z]./;
    ...
    function Vj(a) {
        ...
        return a.remove_ads_by_default ? { Da: !0, ob: b, oa: a.ablation_viewport_offset } : null;
    }
    function Wj(a, b) {
        a = U(a);
    ...
    function mk(a) {
        uf('abg::amalserr', { status: a, guarding: !0, timeout: 50, rate: 0.01 }, 0.01);
    }
    function nk(a, b, c) {
    ...
    var pk = { '120x90': !0, '160x90': !0, '180x90': !0, '200x90': !0, '468x15': !0, '728x15': !0 };
    function qk(a, b) {
        if (15 == b) {
            if (728 <= a) return 728;
            if (468 <= a) return 468;
    ...
    function uk(a, b, c) {
        ...
        ak(b.location, 'google_responsive_dummy_ad') &&
            ...
            2 !== a.h &&
            ((a = JSON.stringify({ googMsgType: 'adpnt', key_value: [{ key: 'qid', value: 'DUMMY_AD' }] })),
            (c.dash =
                '<' +
                sk +
...
*/
    ...
    function Bk(a) {
        ...
        a.G && b++;
        if (3 > b)
            return { J: 'Tags data-matched-content-ui-type, data-matched-content-columns-num and data-matched-content-rows-num should be set together.' };
        b = a.K.split(',');
        var c = a.G.split(',');
        a = a.F.split(',');
        ...
        for (var d = [], e = [], f = 0; f < b.length; f++) {
            var g = Number(c[f]);
            if (isNaN(g) || 0 === g) return { J: "Wrong value '" + c[f] + "' for data-matched-content-rows-num." };
            d.push(g);
            g = Number(a[f]);
            if (isNaN(g) || 0 === g) return { J: "Wrong value '" + a[f] + "' for data-matched-content-columns-num." };
            e.push(g);
        }
        return { G: d, F: e, Ka: b };
    }
        ...
        468 > a
            ? c
                ? ((c = a - 8 - 8),
                  ...
                  (a = { X: a, V: c, F: 1, G: 12, K: 'mobile_banner_image_sidebyside' }))
                : ((a = Ck(a)), (a = { X: a.width, V: a.height, F: 1, G: 13, K: 'image_sidebyside' }))
            : ((a = Ck(a)), (a = { X: a.width, V: a.height, F: 4, G: 2, K: 'image_stacked' }));
        Hk(b, a);
        return new tk(9, new Ek(a.X, a.V));
    }
    function Ik(a, b) {
        Gk(a, b);
        var c = Bk({ G: b.google_content_recommendation_rows_num, F: b.google_content_recommendation_columns_num, K: b.google_content_recommendation_ui_type });
        if (c.J) a = { X: 0, V: 0, F: 0, G: 0, K: 'image_stacked', J: c.J };
            ...
            a =
                1500 < a
                    ? { width: 0, height: 0, ra: 'Calculated slot width is too large: ' + a }
                    : 1500 < d
                    ? { width: 0, height: 0, ra: 'Calculated slot height is too large: ' + d }
                    : { width: a, height: d };
            a = a.ra ? { X: 0, V: 0, F: 0, G: 0, K: e, J: a.ra } : { X: a.width, V: a.height, F: f, G: c, K: e };
        }
    ...
    function Qk(a, b, c, d, e) {
        'false' == e.google_full_width_responsive
            ...
            ? ((b = ci(a, c, d, e)), (c = !0 !== b ? { B: a, C: b } : { B: Cf(c) || a, C: !0 }))
            : (c = { B: a, C: 2 });
        b = c.C;
        return !0 !== b ? { B: a, C: b } : d.parentElement ? { B: c.B, C: b } : { B: a, C: b };
    }
    ...
    function Tk(a, b, c, d, e, f) {
        ...
        l = sf(248, function () {
            ...
            a: if (f) {
                ...
                t = { W: new Jk(a, Math.floor(x)), T: x < t ? 102 : !0 };
            } else t = { W: r, T: 100 };
            return t;
        });
        g = l.W;
        l = l.T;
        return 'in-article' === e.google_ad_layout && Vk(c) ? { W: Wk(a, c, d, g, e), T: !1, na: b, Ja: k } : { W: g, T: l, na: b, Ja: k };
    }
    function Uk(a, b) {
        if ('auto' == a) return 1;
        switch (b) {
        ...
        (f = Cf(b))
            ? 488 > Cf(b)
                ? b.innerHeight >= b.innerWidth
                    ? ((e.google_full_width_responsive_allowed = !0), gi(b, c), (f = { B: f, C: !0 }))
                    : (f = { B: a, C: 5 })
                : (f = { B: a, C: 4 })
            : (f = { B: a, C: 10 });
        var g = f;
    ...
    var cl = la(['https://pagead2.googlesyndication.com/pagead/managed/js/adsense/', '/slotcar_library', '.js']),
        ...
        el = la(['https://googleads.g.doubleclick.net/pagead/html/', '/', '/zrt_lookup.html']),
        ...
        hl = la(['https://pagead2.googlesyndication.com/pagead/managed/js/adsense/', '/show_ads_impl_with_ama', '.js']),
    ...
    function Kl(a) {
        return Q(Mg) ? ((a = nj({ ba: a, ka: Al() })), null != a.h ? (Ll('ok'), (a = Ml(a.h.value))) : (Ll(a.i.message), (a = {})), a) : Ml(a.localStorage);
    }
    function Ml(a) {
        try {
    ...
    function Ll(a) {
        Q(Lg) && uf('abg_adsensesettings_lserr', { s: a, g: Q(Mg), c: Al(), r: 0.01 }, 0.01);
    }
    function Nl(a, b) {
    ...
    function Ol(a) {
        ...
        b = q(b.scripts);
        for (var c = b.next(); !c.done; c = b.next()) if (0 === Nl(c.value, a)) return 0;
        return 1;
    }
    function Pl(a, b) {
        var c = {},
    ...
    function lm(a, b, c, d) {
        ...
        d.hasOwnProperty('init-done')
            ? (kf(
                  ...
                  Wa(H(a, ul, 2), function (g) {
                      return g.toJSON();
                  })
              ),
              kf(hf, d)(
                  Wa(H(a, ge, 1), function (g) {
                      return g.toJSON();
                  }),
                  e
              ),
    ...
    function om(a, b, c) {
        ...
        if (d.plle) mm(Ql(a), 1);
            ...
            d = G(b, sl, 12);
            e = D(b, 9);
            lm(d, Pl(c, b), { Ha: e && !!a.google_disable_experiments, bb: e }, Ql(a));
    ...
    aa.I = function (a, b, c, d, e) {
        ...
        md(b) || (b = new ld(b, { context: a, id: void 0 === e ? 'jserror' : e }));
        ...
        return function () {
            ...
            try {
                ...
                d.google_measure_js_timing &&
                    e &&
                    ((e = { label: a.toString(), value: e, duration: (Dd() || 0) - e, type: f }),
    ...
    function Rm() {
        ...
        if (Q(Ah) && !window.google_plmetrics && window.PerformanceObserver) {
            ...
            for (var b = q(['layout-shift', 'largest-contentful-paint', 'first-input', 'longtask']), c = b.next(); !c.done; c = b.next())
                (c = c.value), Sm(a).observe({ type: c, buffered: !Q(Gh) });
            Tm(a);
        }
    }
    function Sm(a) {
    ...
    function bn(a) {
        ...
        if (document.hasTrustToken && !Q(Jh) && !Array.isArray(window.goog_tt_state)) {
            var c = a.map(function (d) {
                return { issuerOrigin: d.issuerOrigin, state: b.h ? 1 : 12 };
            });
    ...
    function fn() {
        var a = X.issuerOrigin + X.redemptionPath,
            b = { keepalive: !0, trustToken: { type: 'token-redemption', issuer: X.issuerOrigin, refreshPolicy: 'none' } };
        Z(X.issuerOrigin, 2);
        return window
            .fetch(a, b)
            .then(function (c) {
    ...
    function jn() {
        ...
        if (n.Promise) {
            var a = document
                    ...
                    .catch(function (e) {
                        return n.Promise.reject({ state: 19, error: e });
                    }),
            ...
            a = a
                    ...
                    return window
                        ...
                        .catch(function (f) {
                            if (f && 'NoModificationAllowedError' === f.name) Z(Y.issuerOrigin, 18, !0);
                                ...
                                if (e) return n.Promise.reject({ state: 17, error: f });
                                Z(Y.issuerOrigin, 17);
                            }
                        });
                })
                ...
                .then(function (e) {
                    ...
                    Z(Y.issuerOrigin, 20);
                    return window
                        .fetch(f + '?ht=' + e, { trustToken: { type: 'send-redemption-record', issuers: [Y.issuerOrigin] } })
                        .then(function (g) {
                        ...
                        .catch(function (g) {
                            return n.Promise.reject({ state: 21, error: g });
                        });
                });
            var d = Sc(window);
            return a
                    ...
                    return e && e.srqt && e.cs
                        ? (Z(Y.issuerOrigin, 23),
                          window
                              ...
                              .catch(function (g) {
                                  return n.Promise.reject({ state: 24, error: g });
                              }))
                        : e;
                })
                .then(function (e) {
                    if (e && e.srdt && e.cs)
                        return (
                            ...
                            window
                                ...
                                .catch(function (f) {
                                    return n.Promise.reject({ state: 27, error: f });
                                })
                        );
                })
                .then(function () {
                ...
                .catch(function (e) {
                    if (e instanceof Object && e.hasOwnProperty('state') && e.hasOwnProperty('error'))
                        if ('number' === typeof e.state && e.error instanceof Error) {
                            ...
                            var f = R(Mh);
                            Math.random() <= f && Zc({ state: e.state, err: e.error.toString() }, 'dtt_err');
                        } else throw Error(e);
                    else throw e;
                });
        }
    ...
    function kn(a) {
        if (document.hasTrustToken && !Q(Jh) && a.h) {
            ...
            if (n.Promise && n.Promise.all)
                return (
                    (a = n.Promise.all(a)),
                    'object' != typeof window.goog_tt_promise && Object.defineProperty(window, 'goog_tt_promise', { configurable: !1, value: a, writable: !1 }),
                    a
                );
        }
    }
    ...
    function mn() {
        return J.navigator && J.navigator.userAgentData && 'function' === typeof J.navigator.userAgentData.getHighEntropyValues
            ? J.navigator.userAgentData.getHighEntropyValues(ln).then(function (a) {
                  var b = new xj();
                  b = A(b, 1, a.platform);
    ...
    function on(a, b, c) {
        ...
        J.google_sa_queue ||
            ((J.google_sa_queue = []),
            (J.google_sl_win = J),
            (J.google_process_slots = tf(215, function () {
                return pn(J);
            })),
            (a = qn(c, a, b)),
    ...
    function pn(a) {
        var b = a.google_sa_queue,
            c = b.shift();
        a.google_sa_impl || uf('shimpl', { t: 'no_fn' });
    ...
    function yn() {
        var a = hd(v);
        a && ((a = Af(a)), a.tagSpecificState[1] || (a.tagSpecificState[1] = { debugCard: null, debugCardRequested: !1 }));
    }
    function zn(a) {
        cn();
        dn(Al(), Eb(a, 8)) ||
    ...
    var io = !1;
    function ao(a, b, c) {
        Q(hh) && !io && ((io = !0), (a = co(a)) || (a = sn()), uf('predictive_abg', { a_c: a, p_c: b, b_v: c }, 0.01));
    }
    function co(a) {
    ...
    function jo() {
        ...
        uf('cmpMet', { tcfv1: d, tcfv2: a, usp: f ? 1 : 0, fc: c.i ? 1 : 0, ptt: 9 }, R(Ng));
    }
    function ko(a) {
        a = { value: D(a, 16) };
        var b = 0.01;
                      ...
                      if (Q(xh)) {
                          ...
                          try {
                              if (Uc.createEvent)
                                  ...
                                  var e = new d.CustomEvent('adsbygoogle-pub-unpause-ad-requests-event', { bubbles: !1, cancelable: !1, detail: '' });
                                  b.dispatchEvent(e);
                              } else if (ad(d.Event)) {
    ...
    function no(a) {
        uf('adsenseGfpKnob', { value: a, ptt: 9 }, 0.1);
        switch (a) {
            case 0:
            case 2:
                a = !0;
    ...
    function Zn(a, b) {
        ((ba = fk(Tb(Wb(gc(b.nb).toString()), Rh() ? { bust: Rh() } : {}))
            .then(function (c) {
        ...
        p(ba, 'finally')).call(ba, function () {
            In.length = 0;
            uf('slotcar', { event: 'api_ld', time: Date.now() - Ja, time_pr: Date.now() - Kn });
        });
    }
    function po() {
        ...
        a = {};
        for (b = 0; b < In.length; a = { da: a.da, Y: a.Y }, b++)
            Jn.has(b) ||
                ((a.Y = In[b]),
                (a.da = $n(a.Y)),
                sf(
    ...
    function bo(a) {
        ...
        if (2 === $n(a) && 'preroll' === a.type && null != a.adBreakDone) {
            ...
            var c = v.setTimeout(function () {
                try {
                    (0, a.adBreakDone)({ breakType: 'preroll', breakName: a.name, breakFormat: 'preroll', breakStatus: 'timeout' }),
                        Jn.set(b, -1),
                        uf('slotcar', { event: 'pr_to', source: 'adsbygoogle' });
                } catch (d) {
        ...
        sf(166, function () {
            ...
            if ((!Qa() || 0 <= La(Ta(), 11)) && (null == (J.Prototype || {}).Version || !Q(fh))) {
                ...
                if (!h || !h.loaded) {
                    ...
                    try {
                        Object.defineProperty(k, 'requestNonPersonalizedAds', { set: lo }),
                            Object.defineProperty(k, 'pauseAdRequests', { set: mo }),
                            Object.defineProperty(k, 'cookieOptions', { set: no }),
                            Object.defineProperty(k, 'onload', { set: oo });
                    } catch (r) {}
                    if (h)
...
(function () {
    var data = {
        resource: {
            ...
            macros: [
                { function: '__e' },
                { function: '__aev', vtp_varType: 'URL', vtp_component: 'IS_OUTBOUND', vtp_affiliatedDomains: ['list'] },
            ...
            tags: [
                { function: '__gct', vtp_trackingId: 'G-4W5MG3DG4T', vtp_sessionDuration: 0, tag_id: 1 },
                {
                    function: '__get',
                    vtp_eventName: 'click',
                    vtp_settings: [
                ...
                { function: '__dlm', vtp_userInput: ['list', ['map', 'key', 'gtm.gtagReferrer.G-4W5MG3DG4T', 'value', ['macro', 21]]], tag_id: 33 },
                {
                ...
                { function: '__lcl', vtp_waitForTags: false, vtp_checkValidation: true, vtp_uniqueTriggerId: '1_9', tag_id: 39 },
                { function: '__lcl', vtp_waitForTags: false, vtp_checkValidation: true, vtp_uniqueTriggerId: '1_16', tag_id: 40 },
                {
                    function: '__ytl',
                ...
                { function: '__ehl', vtp_groupEvents: true, vtp_groupEventsInterval: 1000, vtp_uniqueTriggerId: '1_30', tag_id: 43 }
            ],
            predicates: [
                ...
                { function: '_eq', arg0: ['macro', 20], arg1: ['list', 'pushState', 'popstate', 'replaceState'], any_of: true },
...
*/
    ...
    var m = window,
        ...
        lc = function (a) {
            var b = H.createElement('div'),
                c = Pb('A<div>' + a + '</div>'),
                d = b;
            if (Vb()) for (; d.lastChild; ) d.removeChild(d.lastChild);
            d.innerHTML = Ob(c);
            b = b.lastChild;
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    var Ic = function (a, b, c) {
            var d = [],
                ...
                g = function (h) {
                    ...
                    if (h instanceof nb) {
                        var u = function () {
                            for (var q = Array.prototype.slice.call(arguments, 0), v = 0; v < q.length; v++) q[v] = Hc(q[v], b, !!c);
                            var w = b ? b.s : wa(),
                                y = new ya(w);
                            b && (y.g = b.g);
    ...
    var Lc = {
        ...
        concat: function (a, b) {
            ...
            for (var e = 1; e < arguments.length; e++)
                if (arguments[e] instanceof ua) for (var f = arguments[e], g = 0; g < f.length(); g++) c.push(f.get(g));
                else c.push(arguments[e]);
            return new ua(c);
        },
        every: function (a, b) {
            for (var c = this.length(), d = 0; d < this.length() && d < c; d++) if (this.has(d) && !b.g(a, this.get(d), d, this)) return !1;
            return !0;
        },
        filter: function (a, b) {
    ...
    var Jf = function (a) {
        ...
        Hf = { id: 'id', name: 'nm', brand: 'br', variant: 'va', list_name: 'ln', list_position: 'lp', list: 'ln', position: 'lp', creative: 'cn' },
        If = ['ca', 'c2', 'c3', 'c4', 'c5'];
    var Kf = function (a) {
            var b = [];
            Oa(a, function (c, d) {
    ...
    var Xg = { __cl: !0, __ecl: !0, __ehl: !0, __evl: !0, __fal: !0, __fil: !0, __fsl: !0, __hl: !0, __jel: !0, __lcl: !0, __sdl: !0, __tl: !0, __ytl: !0 },
    ...
    var ah = $g,
        ...
        ch = null,
        dh = null,
        eh = 'https://www.googletagmanager.com/a?id=' + J.J + '&cv=1',
        fh = {},
        gh = {},
        hh = function () {
            var a = Vg.sequence || 1;
    ...
    function Qh() {
        ...
        a.ics || (a.ics = { entries: {}, set: Rh, update: Sh, addListener: Th, notifyListeners: Uh, active: !1, usedDefault: !1 });
        return a.ics;
    }
    ...
    var hi = [R.D, R.I],
        ii = function (a) {
            ...
            var c = a[R.Ef];
            c && Ug(41);
            for (var d = Ia(b) ? b : [b], e = { hc: 0 }; e.hc < d.length; e = { hc: e.hc }, ++e.hc)
                Oa(
                    a,
                    (function (f) {
                        return function (g, h) {
        ...
        Ni = function (a, b) {
            Mi(a, function (c) {
                for (var d = ['tv.1'], e = 0, f = 0; f < c.length; ++f) {
                    ...
                    n &&
                        h &&
                        (-1 === Gi.indexOf(g) || /^e\d+$/.test(h) || /^[0-9A-Za-z_-]{43}$/.test(h)) &&
    ...
    var fk = function (a, b, c, d) {
            ...
            void 0 == b
                ...
                : (c.encode && (b = encodeURIComponent(b)), (b = ck(b)), (g = a + '=' + b));
            var h = {};
            g = e(g, 'path', c.path);
            var k;
    ...
    function Yk() {
        Wb.userAgentData &&
            Wb.userAgentData.getHighEntropyValues(['architecture', 'model', 'bitness', 'platformVersion', 'uaFullVersion']).then(function () {});
    }
    function Xk() {
        return 'CHECKSUM_EXP_DISABLED';
    }
    ...
    function xl(a, b, c, d, e) {
        ...
        if ((void 0 == jl.enable_gbraid_cookie_write ? 0 : jl.enable_gbraid_cookie_write) && !k && a.gb) {
            var r = a.gb[0],
                t = zl('gb', g),
                u = !1;
            if (!b) for (var q = pl(t), v = 0; v < q.length; v++) q[v].va === r && q[v].labels && 0 < q[v].labels.length && (u = !0);
            u || f('gb', p(r));
        }
    }
    var Bl = function (a, b) {
    ...
    var nn = kn,
        on = { label: J.J + ' Container', children: [{ label: 'Initialization', children: [] }] },
        dn = fn(),
        Vm = {},
        Wm = '',
        Xm = '',
    ...
    function Qn(a, b) {
        if (!b) return b;
        for (var c = 0; c < a.length; c++) if (a[c] && Xe[c] && !Yg[String(Xe[c][pe.zb])]) return !0;
        return !1;
    }
    function Sn(a, b) {
        if (a) {
    ...
    var Zn = { '': 'n', UA: 'u', AW: 'a', DC: 'd', G: 'e', GF: 'f', HA: 'h', GTM: Xn, OPT: 'o' },
        $n = function (a) {
            var b = J.J.split('-'),
                c = b[0].toUpperCase(),
                d = Zn[c] || 'i',
    ...
    var Dr = function (a, b) {
        if ('require' !== b.type)
            if (b.U) for (var c = a.getCommandListeners(b.U)[b.type] || [], d = 0; d < c.length; d++) c[d]();
            else
                for (var e in a.o)
    ...
    function Nr(a) {
        a.hasOwnProperty('gtm.uniqueEventId') || Object.defineProperty(a, 'gtm.uniqueEventId', { value: hh() });
        return a['gtm.uniqueEventId'];
    }
    function Or() {
        if (!Jr && !Vg.gtagRegistered) {
            Jr = Vg.gtagRegistered = !0;
            Vg.addTargetToGroup = function (c) {
                Fr(c, 'default');
            };
            var a = Vg.pendingDefaultTargets;
            delete Vg.pendingDefaultTargets;
            if (Ia(a)) for (var b = 0; b < a.length; ++b) Fr(a[b], 'default');
        }
        return Jr;
    }
    var Pr = {
    ...
    var ys = function () {
            ...
            a.push = function () {
                ...
                var k = c.apply(a, e);
                g && ns.push.apply(ns, e);
                if (300 < this.length) for (Ug(4); 300 < this.length; ) this.shift();
    ...
    var Fs = function (a, b, c) {
            ...
            d['gtm.elementUrl'] =
                (a.attributes && a.attributes.formaction ? a.formAction : '') || a.action || oc(a, 'href') || a.src || a.code || a.codebase || '';
            return d;
        },
        Gs = function (a) {
    ...
    var bt = function (a, b, c) {
        ...
        return {
            createEvent: function (g, h, k) {
                var n = a(),
                    p = n.Ze,
                    r = void 0 !== k ? Math.round(k) : void 0 !== h ? Math.round(n.Ze * h) : Math.round(n.Jg),
                    t = void 0 !== h ? Math.round(100 * h) : 0 >= p ? 0 : Math.round((r / p) * 100),
                    u = H.hidden ? !1 : 0.5 <= ij(c);
                d();
                var q = void 0;
                void 0 !== b && (q = [b]);
    ...
    var fy = function (a) {
            return !a || ey.test(a) || R.ki.hasOwnProperty(a);
        },
        gy = function (a) {
            var b = a[R.xe];
            if (b) return b;
    ...
    var ty = function (a, b) {
        ...
        ry = function (a, b, c) {
            var d = String(c.B(R.ia)),
                ...
                f = Number(c.B(R.qa)),
                g = c.B(R.Qb),
                h = { Ka: R.I, domain: d, path: e, expires: f ? new Date(ab() + 1e3 * f) : void 0, flags: '' + c.B(R.Ha) };
    ...
    var Cy = function (a, b) {
            var c = Ay(b),
                ...
                f = Number(b.B(R.qa)),
                g = nk(a, By[0], d, e),
                h = { Ka: R.I, domain: d, path: e, expires: f ? new Date(ab() + 1e3 * f) : void 0, flags: String(b.B(R.Ha)) };
            return 1 !== gk(c, g, h);
        },
        Dy = function (a) {
            var b = Ay(a),
    ...
    var Vy = function (a, b) {
        ...
        Yy = function (a, b, c) {
            void 0 === c && (c = {});
            if ('object' === typeof b) for (var d in b) Yy(a + '.' + d, b[d], c);
            else c[a] = b;
            return c;
        },
        Zy = function (a) {
    ...
    var ez = function (a, b, c) {
        ...
        if (a.Ke) {
            var k = a.B(R.aa);
            if (Ia(k)) for (var n = 0; n < k.length && 200 > n; n++) f['pr' + (n + 1)] = Jf(k[n]);
        }
        a.He && (f._eu = a.He);
        if ($y) {
    ...
    var sz = function (a, b, c, d) {
            ...
            if (b || c) {
                ...
                b &&
                    (lz('https://stats.g.doubleclick.net/g/collect', 'v=2&' + f.join('&')), fi('https://stats.g.doubleclick.net/g/collect?v=2&' + f.join('&')));
                if (c) {
                    f.push('z=' + Ka());
                    var g = nz(d);
                    g && ec(g + f.join('&'));
    ...
    var tz = window,
        ...
        vz = function (a) {
            ...
            for (var d = Tj('AMP_TOKEN', String(uz.cookie), !0), e = 0; e < d.length; e++) if ('$OPT_OUT' == d[e]) return !0;
    ...
    l.Ij = function (a) {
        ...
        try {
            ...
            a: {
                if (t) {
                    ...
                    if (!(5 > w.length || 6 < w.length)) {
                        v = { sessionId: w[0], Af: Number(w[1]), Td: !!Number(w[2]), lf: Number(w[3]), Gb: Number(w[4] || 0), Oc: '1' === w[5] };
                        break a;
                    }
                }
                v = void 0;
            ...
            if (a.B(R.sa)) {
                var Ya = Fy(a) || {},
                    Fe = il(Ya[R.Tb], !!Ya[R.O]) ? al(!0)._fplc : void 0;
            ...
            var Me = a.K[R.Ae];
            if (Ia(Me)) for (var Ab = 0; Ab < Me.length; Ab++) dy(Me[Ab]);
            var fb = Tg('GA4_EVENT');
            fb && (a.He = fb);
            var Xa = this.gh,
                Ra = this.o,
    ...
    (Y.h.ehl = ['google']),
        (function () {
            ...
            function b(k, n) {
                fc(k, 'hashchange', function (p) {
                    var r = a(p);
                    n({ source: 'hashchange', state: null, url: ht(r), R: gt(r) });
                });
            }
            function c(k, n) {
                fc(k, 'popstate', function (p) {
                    var r = a(p);
                    n({ source: 'popstate', state: p.state, url: ht(r), R: gt(r) });
                });
            }
            function d(k, n, p) {
                var r = n.history,
                ...
                if (Ea(t))
                    try {
                        r[k] = function (u, q, v) {
                            ...
                            p({ source: k, state: u, url: ht(ft()), R: gt(ft()) });
                        };
                    } catch (u) {}
            }
            function e() {
                var k = { source: null, state: V('history').state || null, url: ht(ft()), R: gt(ft()) };
                return function (n, p) {
                    var r = k,
                        t = {};
                    t[r.source] = !0;
    ...
    (Y.h.sdl = ['google']),
        (function () {
            ...
            var p = /^\s*$/,
                r = { vd: 'PERCENT', wd: 'PIXELS' },
                t = { wg: 'vertical', lg: 'horizontal' },
                u,
                q,
                v,
                w = !1,
    ...
    (Y.h.ytl = ['google']),
        (function () {
            ...
            function b(q, v) {
                if (!q) return !1;
                for (var w = 0; w < p.length; w++) if (0 <= q.indexOf('//' + p[w] + '/' + v)) return !0;
                return !1;
            }
            function c(q, v) {
            ...
            function f(q, v) {
                ...
                function x() {
                    P = bt(
                        function () {
                            return { url: L, title: T, Ze: K, Jg: q.getCurrentTime(), playbackRate: Z };
                        },
                        v.Cf,
                        q.getIframe()
                    );
            ...
            function k(q, v, w) {
                var y = q.map(function (A) {
                    return { ca: A, Uc: A, Rc: void 0 };
                });
                if (!v.length) return y;
                var x = v.map(function (A) {
                    return { ca: A * w, Uc: void 0, Rc: A };
                });
            ...
            function n(q) {
                ...
                if (v || w || y || x.length || z.length) {
                    var C = { Te: v, Re: w, Se: y, uf: x, vf: z, Ic: A, Cf: void 0 === q.vtp_uniqueTriggerId ? '' : q.vtp_uniqueTriggerId },
                        E = V('YT'),
                        D = function () {
                            e(C);
                        };
                    ...
                    if (E) E.ready && E.ready(D);
                        ...
                        kt('onYouTubeIframeAPIReady', function () {
                            F && F();
                            D();
                        });
                        I(function () {
    ...
    (function (a) {
        ...
        var f = function (r) {
                ...
                var v = { messageType: 'CONTAINER_STARTING', data: { scriptSource: Xb, containerProduct: t, debug: !1, id: J.J } };
